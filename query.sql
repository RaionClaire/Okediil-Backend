...
ALTER TABLE aset
MODIFY COLUMN id_aset INT NOT NULL AUTO_INCREMENT;

ALTER TABLE pengeluaran
MODIFY COLUMN id_pengeluaran INT NOT NULL AUTO_INCREMENT;

ALTER TABLE pembelian
MODIFY COLUMN id_pembelian INT NOT NULL AUTO_INCREMENT;
